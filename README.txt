...
Description later... see examples. I developed it for the purposes I needed
now (bar and pie charts), so you may find many options missing. I will add 
them if I will need them in next project so please be patient or fork and
contribute. Enjoy.
...
echo $this->GoogleChart->create()
	...
	->addMarker('value', array('format' => 'f1', 'size' => 14, 'color' => '000000', 'placement' => 'c'))
	->addData(array(20, 42.3, 65.21, 95.2))
	->addMarker('value', array('format' => 'f1', 'size' => 14, 'color' => '000000', 'placement' => 'c'))
	->addAxis('x', array('labels' => array('jan 2012', 'feb 2012', 'mar 2012', 'apr 2012'), 'axis_or_tick' => 'l', 'size' => 12))
	->addAxis('y', array('size' => 12));
